  ...
  return (
    <div className="bg-card border border-border rounded-lg p-3 flex flex-wrap items-center justify-between gap-4 text-xs shadow-sm">
      <div className="flex items-center gap-2">
        ...
        <span className="font-semibold text-text-primary">Jetson Orin Nano Edge Stream</span>
      </div>
      <div className="flex items-center gap-4 text-text-secondary font-mono">
        ...
        <div>
          <span className="text-[10px] uppercase block text-text-secondary font-sans">Jetson Temp</span>
          <span className="font-semibold text-amber-600 dark:text-amber-400">{telemetry.jetson_temp_celsius}°C</span>
        </div>
      </div>
    </div>
  );
